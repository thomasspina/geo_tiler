...
/// # Returns
///
/// * `Result<Vec<(f64, f64)>, GeoTilerError>` - Vector of longitude and latitude coordinates
...
///
/// ```
/// use geo_tiler::fibonacci_sphere;
/// use std::f64::consts::PI;
///
...
/// ```
pub fn fibonacci_sphere(n: usize) -> Result<Vec<(f64, f64)>, GeoTilerError> {
    if n == 0 {
